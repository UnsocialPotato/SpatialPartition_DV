...
namespace SpatialPartitionPattern
{
    public class GameController : MonoBehaviour
    {
        ...
        //Change materials to detect which enemy is closest
        ...
        //Save the closest enemier to easier change back its material
        ...
        void Start()
        {
            ...
            for (int i = 0; i < numberOfSoldiers; i++)
            {
                ...
                //Give the frienly a random position
        ...
        { 
            ...
            //Reset material of the closest enemy
            ...
            //For each friendly, find the closest enemy and change it's color and chase it
